...
allowed-tools: Skill, Bash(git status *), Bash(git diff *), Bash(codex exec *), Bash(npm run lint *), Bash(npx eslint *), Bash(ruff check *), Bash(golangci-lint run *), Read, Grep, Glob
---
...
6. `doarakko-config:review-followup` スキルを起動し、その手順に従って修正に入るかを確認する
