...
### ステップ4.5: ユーザーへの確認
検出された修正項目について、ユーザーに確認を求めます。

#### 4.5.1: 全体の修正方針を確認
まず、AskUserQuestionで全体の方針を確認:
...
# 1. 全体方針の確認
# AskUserQuestion: "修正方針を選択してください"
#   - "AIに判断を任せる（推奨）" → AI判断で修正実行
#   - "個別に選択する" → 各項目を個別確認

# 2. 個別選択の場合、各項目について確認
# AskUserQuestion: "[項目名] をどうしますか？"
#   - "AIに判断を任せる" → AIがこの項目の対応要否を判断
#   - "修正する" → 修正対象に追加
#   - "修正しない" → スキップ
```
...
記載すべき項目が見つかった場合、各項目についてAskUserQuestionで個別に確認:
- **追加する**: CLAUDE.md・コーディング規約に追記
- **追加しない**: スキップ
